        ...
        //Step 2 go inside each network to check enterprises
            for(Network nw: system.getNetworkList()){
                for(Enterprise ep : nw.getEnterpriseDirectory().getEnterpriseList()){
                    userAccount = ep.getUserAccountDirectory().authenticateUser(userName, password);
                    if(userAccount == null){
...
//            if (userAccount != null){
//                CardLayout layout = (CardLayout) container.getLayout();
//                container.add("workArea", userAccount.getRole().createWorkArea(container, userAccount, organization, system));
//                layout.next(container);
//                break;
//            }
//        }
