...
public class ConfigureASystem {
    ...
    public static EcoSystem configure(){
        ...
        employee = phsEnterprise.getEmployeeDirectory().createEmployee("PHS");
        phsEnterprise.getUserAccountDirectory().createUserAccount("phs", "123", employee, new PHSAdminRole());
        
        employee = hspEnterprise.getEmployeeDirectory().createEmployee("HSPAdmin");
        ...
        employee = supOrganization.getEmployeeDirectory().createEmployee("Siemens Medical");
        ...
        employee = organization.getEmployeeDirectory().createEmployee("Asset Admin");
        ...
        employee = organization.getEmployeeDirectory().createEmployee("Accounting");
        ...
        Employee employee1 = organization.getEmployeeDirectory().createEmployee("Martin");
        UserAccount userAccount = organization.getUserAccountDirectory().createUserAccount("doc", "123", employee1, new DoctorRole()); 
        
        Employee employee2 = organization.getEmployeeDirectory().createEmployee("Jerry");
        ...
        Employee employee3 = organization.getEmployeeDirectory().createEmployee("Jessy");
        ...
        mdp.setDescription("Plused nuclear magnetic resonance.");
        mdp.setModel("Md00001");
        mdp.setName("Plused NMR");
